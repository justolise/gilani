    ...
    <footer className="relative z-40 w-full flex-none border-t border-white/10 bg-[#101010]/98 backdrop-blur-md py-2.5 sm:py-3.5">
      <div className="mx-auto flex flex-col items-center justify-center max-w-7xl px-4 sm:px-8 gap-2">
        ...
        <div className="flex w-full items-center justify-between gap-4">
          {/* Desktop Links (all open in interactive modals) */}
          <div className="hidden lg:flex items-center gap-6 font-medium text-sm text-white/75">
            <button
              type="button"
          ...
          {/* Socials & Action Icons (Centered on mobile, right on desktop) */}
          <div className="flex items-center justify-center lg:justify-end w-full lg:w-auto gap-3 sm:gap-4">
            {/* Updates Popover Button */}
            <Popover>
              <PopoverTrigger asChild>
                <button
                  type="button"
                  aria-label="Subscribe to updates"
                  className="inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-white/10 px-3 sm:px-4 py-1.5 sm:py-2 text-xs font-semibold text-white hover:bg-white/15 hover:border-white/25 transition-all cursor-pointer shadow-sm"
                >
                  <Mail className="h-3.5 w-3.5 text-[#E28743]" />
                  <span>Updates</span>
                </button>
              </PopoverTrigger>
              <PopoverContent
            ...
            {/* Social Icons: WhatsApp, Instagram, Facebook (Vibrant colors & larger touch targets) */}
            <div className="flex items-center gap-2 sm:gap-2.5">
              <a
                ...
                aria-label="WhatsApp"
                className="text-[#25D366] hover:scale-110 transition-transform p-1.5 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 flex items-center justify-center"
              >
              ...
              <a
                ...
                className="text-[#E4405F] hover:scale-110 transition-transform p-1.5 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 flex items-center justify-center"
              >
                <svg className="w-4 h-4 sm:w-4.5 sm:h-4.5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="text-[#1877F2] hover:scale-110 transition-transform p-1.5 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 flex items-center justify-center"
              >
                <svg className="w-4 h-4 sm:w-4.5 sm:h-4.5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Popover open={menuOpen} onOpenChange={setMenuOpen}>
              <PopoverTrigger asChild>
                <button
                  ...
                  className="inline-flex items-center justify-center rounded-full border border-[#C96A3D]/40 bg-[#C96A3D]/15 h-8 w-8 sm:h-9 sm:w-9 text-[#E28743] hover:bg-[#C96A3D]/25 hover:scale-105 active:scale-95 transition-all shadow-md cursor-pointer"
                >
        ...
        {/* Bottom Row: Version and Copyright placed BELOW the icons */}
        <div className="flex items-center justify-center gap-2 text-[11px] sm:text-xs text-white/55">
          <span>&copy; {new Date().getFullYear()}</span>
          <span className="text-white/30">·</span>
          <span className="text-[#E28743] font-mono font-bold bg-[#C96A3D]/10 border border-[#C96A3D]/25 px-1.5 py-0.5 rounded text-[10px] sm:text-[11px]">
            v{pkg.version}
          </span>
        </div>
      </div>
